(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.WDSA = factory());
  ...
  const libPrefix = "wab";
  function generateLibName(libName) {
  ...
  class WdsaAnimator extends WdsaBasic {
    static libName = generateLibName("wdsa_animator");
    _defaultOptions = {
  ...
  class WdsaObserver extends WdsaBasic {
    // @ts-ignore
    static libName = generateLibName("wdsa_observer");
    _defaultOptions = {
      scrollRoot: window
    };
    /**
  ...
  class WDSA extends WdsaBasic {
    static libName = generateLibName("wdsa");
    static _observers = [];
    static _libInstance;
    constructor() {
      super("wdsa");
    ...
    static register(options) {
      ...
      if (container[this.libName]) {
        instance = this._observers.find((instance2) => instance2.id === container[this.libName].id);
